 ...
 implements PersonaApp.PersonaOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("eliminarPersona", new java.lang.Integer (1));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // PersonaApp/Persona/insertarPersona
       {
         ...
         $result = this.insertarPersona (id, nombre, apellido, direccion, genero, estado);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 1:  // PersonaApp/Persona/eliminarPersona
       {
         int id = in.read_long ();
         boolean $result = false;
       ...
       case 2:  // PersonaApp/Persona/actualizarPersona
       {
         ...
         String estado = in.read_wstring ();
         boolean $result = false;
         $result = this.actualizarPersona (id, nombre, apellido, direccion, genero, estado);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 3:  // PersonaApp/Persona/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
